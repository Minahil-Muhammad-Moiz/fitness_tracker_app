...
class LoginActivity : AppCompatActivity() {
    ...
    private lateinit var forgotPasswordText: TextView // Added variable declaration
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        forgotPasswordText = findViewById(R.id.forgotPasswordText) // Find view inside layout
        ...
        // NAVIGATION: Login -> Forgot Password Placeholder Screen
